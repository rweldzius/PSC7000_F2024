...
- Load data from [github](https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/nba_players_2018.Rds)

```{r}
nba <- read_rds('https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/nba_players_2018.Rds')
```
...
- [`psc4175_hw_5.html`](https://github.com/rweldzius/PSC4175_F2024/raw/main/Homeworks/psc4175_hw_5.html) has the full codebook
...
- Go to gosocrative.com and take the **5th** quiz
...
--
  ...
  1. Work through psc4175_hw_6.Rmd
  
  2. Problem Set 3 due Friday by midnight (submit PDFs only!)
