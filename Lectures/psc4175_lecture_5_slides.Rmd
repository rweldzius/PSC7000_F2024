...
- Download [`MI2020_ExitPoll.rds`](https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/MI2020_ExitPoll.rds) to your `data` folder
...
```{r}
MI_raw  <- read_rds('https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/MI2020_ExitPoll.rds')
```
...
- Go to gosocrative.com and take the **4th** quiz
...
--
  ...
  1. Work through psc4175_hw_5.Rmd
