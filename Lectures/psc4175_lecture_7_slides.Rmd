...
- Download pre-wrangled data from [GitHub](https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/MI2020_ExitPoll_small.rds) and save to your `data` folder.
...
- Go to gosocrative.com and take the **6th** quiz
...
--
  ...
  1. Work through psc4175_hw_7.Rmd
