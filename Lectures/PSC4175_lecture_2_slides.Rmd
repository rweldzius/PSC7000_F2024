...
set.seed(123)
options(width=60)
knitr::opts_chunk$set(tidy.opts = list(width.cutoff = 60),tidy=TRUE,fig.align='center',fig.width=9,fig.height=5,message=F,warning=F)
...
- You can save it locally from the course  [github page](https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/sc_debt.Rds) and then load it from your computer
...
--
  ...
  - url: https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/sc_debt.Rds
---
...
- Go to Blackboard and take the **1st** quiz
...
--
  ...
  2. Problem set 1 will be posted next Monday (Labor Day); due next Friday by midnight
