...
--
  ...
  - Download and open [`Pres2020_PV.Rds`](https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/Pres2020_PV.Rds)
...
require(tidyverse)
poll <- read_rds('https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/Pres2020_PV.Rds')
...
- Load [`Pres2020_StatePolls.Rds`](https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/Pres2020_StatePolls.Rds) to `statePoll` object

```{r,message = F,warning=F}
require(tidyverse)
statePoll <- read_rds('https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/Pres2020_StatePolls.Rds')
```
...
- Go to gosocrative.com and take the **8th** quiz
...
--
  ...
  1. Work through psc4175_hw_9.Rmd
