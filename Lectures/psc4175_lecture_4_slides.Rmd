...
- Load the data from the course [github page](https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/sc_debt.Rds) directly using `read_rds()`
...
- Go to gosocrative.com and take the **3rd** quiz
...
--
  ...
  1. Work through psc4175_hw_4.Rmd
