...
require(tidyverse)
require(plotly)
sc_debt <- read_rds('https://github.com/rweldzius/psc7000_F2024/raw/main/Data/sc_debt.Rds')
```
...
## Part II: Predicting movie revenues
...
```{r}
p <- mvEval1 %>%
  ggplot(aes(x = log_budget,y = errors)) + 
  geom_point() + 
  geom_smooth() + 
