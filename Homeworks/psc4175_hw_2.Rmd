...
## Load The Data
Remember to load the data from  [GitHub]('https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/sc_debt.Rds) and save it to the `data` folder you created. You should then open it in `R` by assigning it to an object with the `<-` command.
