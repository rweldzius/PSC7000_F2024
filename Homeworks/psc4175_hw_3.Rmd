...
## Load The Data
Once `tidyverse` is loaded, you can download the data directly from  [GitHub](https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/sc_debt.Rds) using the `read_rds()` function. You should then open it in `R` by assigning it to an object with the `<-` command.
