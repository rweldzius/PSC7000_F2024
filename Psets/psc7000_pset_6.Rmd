...
Accept defaults and save this file as `[YOUR NAME]_ps6.Rmd` to your `code` folder.
...
We will be using the fn_cleaned_final.Rds file from the course [github page](https://github.com/rweldzius/PSC7000_F2024/blob/main/Data/fn_cleaned_final.Rds). The codebook for this dataset is produced below.
...
## Question 0
*Require `tidyverse`, `tidymodels` and `ranger`, and then load the [`fn_cleaned_final.Rds`](https://github.com/rweldzius/PSC7000_F2024/raw/main/Data/fn_cleaned_final.rd') data to an object called `fn`.*
```{r,message=F}
# INSERT CODE HERE
```
...
## Question 2 [2 points]
*Now let's run a linear model and evaluate it in terms of overall accuracy, sensitivity and specificity using a threshold of 0.5. (Hint: in the homework you do this for the logistic model -- i.e., GLM; it's the same, you just use a linear model!)*
...
*Use 100-fold cross validation with a 60-40 split to calculate the average AUC for both models. Which is better?*
