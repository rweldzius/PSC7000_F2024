# PSC 7000: Research Concepts and Methods (Fall 2024)
...
This graduate-level course delves into the foundational concepts and advanced techniques of empirical research in political science. In the first half of the course, students will complete an in-depth exploration of qualitative research methods in political science, with a primary focus on the principles outlined in the seminal text, *Designing Social Inquiry* by King, Keohane, and Verba. Students will engage with the theoretical and practical aspects of qualitative research, learning to design, conduct, and analyze qualitative studies effectively.
